		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<c:choose>
					...
					>
						<tr
							dir-paginate="u in reservations|filter:search|itemsPerPage:10"
							ng-show="(u.store.storeName=='${sessionScope.ACTIVE_LOGGED_USER.store.storeName}')"
							ng-hide="!(u.store.storeName=='${sessionScope.ACTIVE_LOGGED_USER.store.storeName}')"
						>
