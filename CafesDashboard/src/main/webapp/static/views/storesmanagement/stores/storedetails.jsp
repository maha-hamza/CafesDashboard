...
<c:choose>
								...
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-xs-8 ">
											...
											<p
												style="font-size: 2vmin !important; text-align: left; word-wrap: break-word;"
												...
												>
													...
													<tbody>
														<tr ng-show="storeDetails.branches.length==0">
															<td colspan="7"><center>No records to
																	display</center></td>
														</tr>
														<tr
														...
														>
															...
															<td><a
																...
																data-toggle="modal"
																data-target="#branchedescription"
																ng-click="showdesc(u.description)"
															><i class="fa fa-align-left"></i></a></td>
															<td>{{u.latitude}}</td>
															<td>{{u.langitude}}</td>
														</tr>
													</tbody>
	...
	<c:otherwise>
		<div
			id="clickStoreDetailsForm"
			emd-redirect-to="#/branchdetails/${sessionScope.ACTIVE_LOGGED_USER.branch.uuid}"
		>
			<a
				id="clickStoreDetailsFormAnchor"
				href="#/branchdetails/${sessionScope.ACTIVE_LOGGED_USER.branch.uuid}"
			></a>
		</div>
	</c:otherwise>
</c:choose>
<script>
    $(document).ready(
            function () {
                $("#clickStoreDetailsForm")
                        .find('#clickStoreDetailsFormAnchor').trigger('click');
            });
</script>