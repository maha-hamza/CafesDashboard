	...
	<div class="row">
		...
		<div class="col-lg-12">
			<h3>
				...
				>Users</a> <span>/ User Details </span>
			</h3>
			<div
				class="form-group"
				style="margin-right: 0px; float: right;"
				ng-hide="userDetails.role.roleName=='GUEST'"
			>
				<a
											...
											<div>
												<table class="table table-striped table-hover">
													<tbody>
														...
														<tr>
															<td>Member Since</td>
															<td>{{userDetails.createdAt|date:'MM/dd/yyyy @h:mma'}}</td>
														</tr>
														<tr>
															<td>Last Updated</td>
															<td>{{userDetails.updatedAt|date:'MM/dd/yyyy @h:mma'}}</td>
														</tr>
													</tbody>
												</table>
											</div>
