<div class="modal fade" id="DeleteStatus" ng-show="showDeletion" tabindex="-1" role="dialog"
...
<!-- 			</div> -->
			<div class="modal-body">Are you sure you want to delete  {{activeStatus.status}}?</div>
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary"  id="primary-delete"
					ng-click="deleteStatus(activeStatus.id)">Delete</button>
			</div>
		</div>
	</div>
</div>